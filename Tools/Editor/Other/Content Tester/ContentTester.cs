...
{
	[Library( "tool.content_tester", Title = "Content Tester", Help = "Quickly test compiled content in game", Group = "Testing" ), Icon( EditorIcons.Game ), HelpURL( "https://github.com/Woosh-Crew/Espionage.Engine/wiki" )]
